...
<?PHP
	...
	$listaConsultas[] = array( "1", "Relação de Usuários do Contábil" );
	$listaConsultas[] = array( "2", "Listagem do plano de contas" );
...
<?
	 ...
	 // Consulta ....
	 ?>
	 <body class="pagina" onLoad="alert('Executa a consulta selecionada...');history.back();">
	 <div align="center">
	 </div>
	 </body>
	 <?
