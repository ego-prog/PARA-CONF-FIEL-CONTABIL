...
<?PHP
	...
	if ( empty( $controleNavegacao ) )
	 ...
	 default: {
		  ...
		  $cabec = new TituloCw( $cabecConsBalanco );
		  $cabec->mostra();
?>
<body class="pagina" onLoad="this.document.formConsBalanco.dataInicial.focus();">

	<div align="center">

	<br><br>

	<form action="cwConsBalanco.php"
				name="formConsBalanco" method="get" onSubmit="return validaDados();">
	...
	<input type="hidden" name="controleNavegacao" value="1">
		...
		<table border="0" width="100%">
			...
			<td background="../imagens/cw_janela.gif" border="0" width="85%" class="tjanela">
				<?PHP echo $tituloConsBalanco; ?>
			</td>
			<td width="15%" align="center" class="tjanela">
				<input type="button" class="btitulo" name= "bt_ajuda"
					value="<?= $botaoAjudaJanela; ?>" onClick="javascript:abreAjuda('../cw_ajuda.html#cwConsBalanco')">
		...
		<table class="cjanela" border="0" width="100%">
			...
			<tr>
				...
				<td width="70%" align="left">
					...
					OnClick="javascript:abreAjuda('../cw_ajuda.html#cwConsBalanco');">
				</td>
			</tr>
...
<?PHP
	 ...
	 case 1: {
		 ...
		 $resposta = $lancamento->consultaBalanco( $dataInicial, $dataFinal,
					$oidEmpresaCont, $oidEmpresa, $paginaInicial, $exibeNaoLiberado,
						$exibeContador, $perfilUsuario );
		 if (  $resposta == "0" ) {
		 ...
		 if (  $resposta == "2" ) {
			echo "<body class=\"pagina\"><center>";
			$msg = new MsgCw( $msgContasResultadoSaldo,
				"../imagens/contabil.jpg", "javascript:history.go(-1);" );
			$msg->mostra();
			echo "</center></body>";
			exit;
...
<?
		 ...
		 $lancamento = new Lancamento();
		 $lancamento->consultaBalancoPDF( $dataInicial, $dataFinal, $oidEmpresaCont,
