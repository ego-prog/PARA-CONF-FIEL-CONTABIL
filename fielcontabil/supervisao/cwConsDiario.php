...
<!--
	...
	Módulo: cwConsDiario.php
	  Consulta de Diário de Lançamentos
-->
<html>
<head>
...
<?PHP
	...
	if ( empty( $controleNavegacao ) )
	 ...
	 default: {
		  ...
		  $cabec = new TituloCw( $cabecConsDiario );
		  $cabec->mostra();
?>
<body class="pagina" onLoad="this.document.formConsDiario.dataInicial.focus();">

	<div align="center">

	<br><br>

	<form action="cwConsDiario.php"
				name="formConsDiario" method="get" onSubmit="return validaDados();">
	...
	<input type="hidden" name="perfilUsuario" value="<?= $perfilUsuario; ?>">
		...
		<table border="0" width="100%">
			...
			<td background="../imagens/cw_janela.gif" border="0" width="85%" class="tjanela">
				<?PHP echo $tituloConsDiario; ?>
			</td>
			<td width="15%" align="center" class="tjanela">
				<input type="button" class="btitulo" name= "bt_ajuda"
					value="<?= $botaoAjudaJanela; ?>" onClick="javascript:abreAjuda('../cw_ajuda.html#cwConsDiario')">
		...
		<table class="cjanela" border="0" width="100%">
			...
			<tr>
				...
				<td align="left" width="70%" class="cjanela">
				   <input type="checkbox" class="cbjanela" name="exibeNaoLiberado"
						value="false"><?= $msgExibeNaoLiberados; ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td align="left" width="70%" class="cjanela">
				   <input type="checkbox" class="cbjanela" name="exibeQuebras"
						value="false"><?= $msgExibeQuebras; ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="70%" align="left">
					...
					OnClick="javascript:abreAjuda('../cw_ajuda.html#cwConsDiario');">
				</td>
			</tr>
...
<?PHP
	 ...
	 case 1: {
		 ...
		 if ( $lancamento->consultaDiario( $dataInicial, $dataFinal, $oidEmpresaCont,
					 $oidEmpresa, $paginaInicial, $exibeNaoLiberado, $exibeContador, $perfilUsuario, $exibeQuebras ) == false ) {
...
<?
		 ...
		 $lancamento = new Lancamento();
		 $lancamento->consultaDiarioPDF( $dataInicial, $dataFinal,
							$oidEmpresaCont, $oidEmpresa, $paginaInicial,
							$exibeContador, $exibeQuebras );
		break;
?>
	</div>
</body>
