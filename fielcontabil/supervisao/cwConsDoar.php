...
<?PHP
	...
	if ( empty( $controleNavegacao ) )
	 ...
	 default: {
		  ...
		  $cabec = new TituloCw( $cabecConsDoar );
		  $cabec->mostra();
?>
<body class="pagina" onLoad="this.document.formConsDoar.dataInicial.focus();">

	<div align="center">

	<br><br>

	<form action="cwConsDoar.php"
				name="formConsDoar" method="get" onSubmit="return validaDados();">
	...
	<input type="hidden" name="controleNavegacao" value="1">
		...
		<table border="0" width="100%">
			...
			<td background="../imagens/cw_janela.gif" border="0" width="85%" class="tjanela">
				<?PHP echo $tituloConsDoar; ?>
			</td>
			<td width="15%" align="center" class="tjanela">
				<input type="button" class="btitulo" name= "bt_ajuda"
					value="<?= $botaoAjudaJanela; ?>" onClick="javascript:abreAjuda('../cw_ajuda.html#cwConsDoar')">
		...
		<table class="cjanela" border="0" width="100%">
			...
			<tr>
				...
				<td width="70%" align="left">
					...
					OnClick="javascript:abreAjuda('../cw_ajuda.html#cwConsDoar');">
				</td>
			</tr>
...
<?PHP
	 ...
	 case 1: {
		 ...
		 $doar = new ContaDoar();
		 if ( $doar->consultaDoar( $dataInicial, $dataFinal, $oidEmpresaCont, 
					 $oidEmpresa, $paginaInicial, $exibeNaoLiberado, $exibeContador, $perfilUsuario ) == false ) {
...
<?
		 ...
		 $doar = new ContaDoar();
		 $doar->consultaDoarPDF( $dataInicial, $dataFinal, 
