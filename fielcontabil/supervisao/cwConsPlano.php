...
<?PHP
	...
	if ( empty( $controleNavegacao ) )
	 ...
	 default: {
		  ...
		  $cabec->mostra();
?>
<body class="pagina" onLoad="this.document.formConsPlano.oidEmpresaCont.focus();">

	<div align="center">

	<br><br>

	<form action="cwConsPlano.php"
...
<?PHP
	 ...
	 case 1: {
		 ...
		 $conta = new Conta();
		 if ( $conta->consultaPlanoContas( $oidEmpresaCont, $oidEmpresa, $perfilUsuario, $paginaInicial ) == false ) {
