				...
				<table class="cjanela" border="0" width="80%">
					...
					<tr>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsDiario.php"><?PHP echo $opcaoRelDiarioLancamentos; ?></a>
						</td>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsRazao.php"><?PHP echo $opcaoRelRazaoAnalitico; ?></a>
						</td>
					</tr>
					<tr>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsAnalitico.php"><?PHP echo $opcaoRelBalanceteAnalitico; ?></a>
						</td>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsDemoResult.php"><?PHP echo $opcaoRelDemonstrativoResultados; ?></a>
						</td>
					</tr>
					<tr>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsBalanco.php"><?PHP echo $opcaoRelBalanco; ?></a>
						</td>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsDoar.php"><?PHP echo $opcaoRelDoar; ?></a>
						</td>
					</tr>
					<tr>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsOrcamento.php"><?PHP echo $opcaoRelAcompanhamentoOrcamento; ?></a>
						</td>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsPlano.php"><?PHP echo $opcaoRelPlanoContas; ?></a>
						</td>
					</tr>
					<tr>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsPlanoDoar.php"><?PHP echo $opcaoRelPlanoContasDoar; ?></a>
						</td>
						<td align="center" class="cjanela" width="50%">
							<a href="cwConsRetrospectiva.php"><?= $opcaoRelRetrospectiva; ?></a>
						</td>
					</tr>
